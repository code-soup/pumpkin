...
const publicPath =
	...
	`${process.env.WP_CONTENT_PATH || '/wp-content/themes'}/${pluginDirName}/dist/`;
...
const config = {
	 ...
	 * @example
	 * entry: {
	 *   'my-bundle': ['./src/scripts/my-script.js', './src/styles/my-style.scss'],
	 * }
	 */
	entry: {
		"admin": ["./src/scripts/admin.js", "./src/styles/admin.scss"],
		"common": ["./src/scripts/main.js", "./src/styles/main.scss"],
	},
